...
<body>
		...
		<?php include 'new_request.html'; ?>
	  	...
	  	<div class="row">
			<ul class="nav nav-tabs nav-justified">
				<li role="presentation"><a href="index.php">Customers</a></li>
				<li role="presentation"><a href="#">Samples</a></li>
				<li role="presentation"><a href="#">Replacements</a></li>
				<li role="presentation" class="active"><a href="early_ships.php">Early-Ships</a></li>
			</ul>
		</div>
	...
	<script src="js/early_ships.js" ></script>
