...
EditableGrid.prototype.dateFormat = "US";
...
EditableGrid.prototype.init = function(b, a) {
    ...
    if (this.enableSort) {
        ...
        if (typeof a != "undefined" && typeof a.sortIconUp != "undefined") {
            this.sortUpImage.src = a.sortIconUp
        } else {
            this.sortUpImage.src = this.baseUrl + "/images/bullet_arrow_up.png"
        }
        this.sortDownImage = new Image();
        if (typeof a != "undefined" && typeof a.sortIconDown != "undefined") {
            this.sortDownImage.src = a.sortIconDown
        } else {
...
EditableGrid.prototype._callback = function(b, a, c) {
    if (c) {
        c.call(this)
    } else {
        if (this.serverSide) {
            this.refreshGrid = function(e) {
                e = e || this.lastURL;
                this.lastURL = e;
                var d = e + (e.indexOf("?") >= 0 ? "&" : "?") + "page=" + (this.currentPageIndex + 1) + "&filter=" + (this.currentFilter ? encodeURIComponent(this.currentFilter) : "") + "&sort=" + (this.sortedColumnName && this.sortedColumnName != -1 ? encodeURIComponent(this.sortedColumnName) : "") + "&asc=" + (this.sortDescending ? 0 : 1);
                var f = function() {
...
EditableGrid.prototype.setValueAt = function(g, e, h, a) {
    ...
    if (e < 0 || e >= this.columns.length) {
        alert("[setValueAt] Invalid column index " + e);
        return null
    }
...
EditableGrid.prototype.setEnumProvider = function(d, b) {
    ...
    if (c < 0) {
        alert("[setEnumProvider] Invalid column: " + d)
    } else {
...
EnumCellRenderer.prototype.render = function(b, c) {
    ...
    b.innerHTML = this.column.datatype != "html" ? htmlspecialchars(a, "ENT_NOQUOTES").replace(/\s\s/g, "&nbsp; ") : a
};
